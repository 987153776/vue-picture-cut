...
// CONCATENATED MODULE: ./src/lib/views/vue-picture-cut.vue?vue&type=template&id=808f65fe&
...
var PhotoMain_PhotoMain = /*#__PURE__*/function () {
  ...
  _createClass(PhotoMain, [{
    ...
    value: function wheelStart(zoom, point) {
      ...
      var offPoint = tool.rotatePoint(core.x, core.y, !sV && sH || sV && !sH ? r : -r);
    ...
    value: function _touchStart1(tp) {
      ...
      var offPoint = tool.rotatePoint(tp.x, tp.y, !sV && sH || sV && !sH ? r : -r);
      this.touchstartPoint = this._getPointerLocation(offPoint);
    }
  }, {
    key: "_touchStart2",
...
var vue_picture_cut_menu_component = normalizeComponent(
  ...
  vue_picture_cut_menuvue_type_template_id_0aa86ce8_render,
  vue_picture_cut_menuvue_type_template_id_0aa86ce8_staticRenderFns,
  false,
  null,
  null,
  null
