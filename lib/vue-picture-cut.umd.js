...
var Utils_Utils = /*#__PURE__*/function () {
  ...
  _createClass(Utils, [{
    ...
    value: function setFlipV(animation) {
      if (!this.photoRoot) return;
      var main = this.photoRoot.getEventList('PhotoMain');
      main === null || main === void 0 ? void 0 : main.setFlipV(!main.showRect.sV, animation);
    }
    /**
     * 设置图片水平翻转
     * @param animation   是否动画
    ...
    value: function setFlipH(animation) {
      if (!this.photoRoot) return;
      var main = this.photoRoot.getEventList('PhotoMain');
      main === null || main === void 0 ? void 0 : main.setFlipH(!main.showRect.sH, animation);
    }
    /**
     * 设置图片翻转
     * @param sV          垂直
    ...
    value: function setFlip(sV, sH, animation) {
      if (!this.photoRoot) return;
      var main = this.photoRoot.getEventList('PhotoMain');
      main === null || main === void 0 ? void 0 : main.setFlip(!main.showRect.sV, !main.showRect.sH, animation);
    }
    /**
     * 图片缩放
     * @param zoom    缩放系数
